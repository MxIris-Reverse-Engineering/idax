...
public nonisolated struct MachOArchitecture: RawRepresentable, Hashable, Sendable {
...
nonisolated extension MachOArchitecture: ExpressibleByArgument {
    public init?(argument: String) {
        self.init(rawValue: argument)
    }
}

nonisolated extension MachOArchitecture: CustomStringConvertible {
    public var description: String { rawValue }
}

/// Chooses which architecture slice of an input file to load.
public nonisolated enum SliceResolver {
